    ...
    <>
      <div className='w-full h-auto bg-black py-24 px-6 md:px:12 lg:px-20 md:py-32 '>
       <div className='flex flex-col items-center'>
                        ...
                        <p className="text-base text-center mt-6 md:text-lg font-sans lg:text-lg text-[#838488] max-w-2xl mx-auto leading-relaxed transition-all duration-1000 delay-400">
                        Connect with us across LinkedIn, Facebook, and Instagram to get the latest updates, insights, and news.
                        </p>
                        <div className='flex gap-4'>
                           <div className='px-12 py-6 rounded-xl border border-[#68696d]'>
                            <svg xmlns="http://w3.org" viewBox="0 0 24 24" width="24" height="24" fill="#1877F2">
  ...
  <defs>
    <linearGradient id="instagram-gradient" x1="0%" y1="100%" x2="100%" y2="0%">
      ...
      <stop offset="100%" stop-color="#285AEB"/>
                            ...
                            <div className='px-12 py-6 rounded-xl border border-[#68696d]'>
                          <svg xmlns="http://w3.org" viewBox="0 0 24 24" width="24" height="24" fill="#0A66C2">
